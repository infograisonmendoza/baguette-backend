...
export interface ApiMenuItemMenuItem extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    options: Schema.Attribute.Component<'dish-props.dish-option', true>;
    photos: Schema.Attribute.Component<'shared.profile', true> &
    ...
    profile_image: Schema.Attribute.Component<'shared.profile', false>;
    publishedAt: Schema.Attribute.DateTime;
...
export interface ApiTableTable extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    idByName: Schema.Attribute.UID<'table_name'>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<'oneToMany', 'api::table.table'> &
      Schema.Attribute.Private;
    occupied: Schema.Attribute.Boolean & Schema.Attribute.DefaultTo<false>;
    publishedAt: Schema.Attribute.DateTime;
    ...
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    waiter: Schema.Attribute.Relation<'manyToOne', 'api::waiter.waiter'>;
  };
}
...
export interface ApiWaiterWaiter extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    waiterAlias: Schema.Attribute.UID<'alias'>;
  };
}
